...
public class TestConfig{
	...
	public static String from = "niklesh.dubey89@gmail.com";
	public static String password = "Arc@1986";
	public static String[] to ={"niklesh.dubey89@gmail.com","archanakpsharma@gmail.com"};
